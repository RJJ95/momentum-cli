...
- src --- Very important folder. Houses all/most of our Javascript code.
  ...
  - components --- All components are in here. Our app consists mostly of components, in all theur forms and epic glory.
    - atoms --- These are the smallest components. They consist of nothing other than a single element.
    - molecules --- Molecules are components which are constructed of other components. These can be atoms and other molecules.
    - organisms --- Organisms are big chunks of a page. They can consist of atoms, and molecules.
    - layouts --- Layouts are components which are not presented in the UI, but are still components.
